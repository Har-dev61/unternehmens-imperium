...
function boot() {
    ...
    const enterGame = async () => {
        ...
        try {
            ...
            notifications.show({ title: 'Verbindungsfehler', text: e.message, icon: '⚠️', kind: 'error', duration: 5000 });
            ...
            if (onlineManager.usingServer)
                setTimeout(() => void enterGame(), 3000);
            else
                ui.showLoginGate(enterGame);
            return;
        }
